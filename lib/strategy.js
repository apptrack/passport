...
/**
 * Retrieve user profile from Apptrack.
 *
 * This function constructs a normalized profile, with the following properties:
 *
 *   - `provider`         always set to `apptrack`
 *   - `id`               the user's Apptrack ID
 *   - `username`         the user's Apptrack username
 *   - `displayName`      the user's full name
 *   - `profileUrl`       the URL of the profile for the user on Apptrack
